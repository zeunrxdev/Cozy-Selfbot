...
{www}║            Cozy Selfbot                ║
{www}╠════════════════════════════════════════╣
{www}║ Made by: {mjj}Lappy                         {www}║
{www}║ Version: {mjj}1.0                           {www}║
{www}║ Discord: {mjj}https://discord.gg/roster     {www}║
...
{magenta}
                                ...
                                ⠀⠀⠀⠀⢠⡿⠁⡜⢀⠇⡎⡞⠀⡼⡜⠉⠀⣰⢃⠏⠀⡇⢐⡌⣿⣿⣿⣿⣿⣿⣿⣿⠿⠿⠿⠿⣿⢿⣿⣿⣤⠀
                                ⠀⠀⠀⠀⠸⡅⠰⣇⡼⣸⠸⠀{red}⣼⣽⣤{magenta}⢰⡀⣠⢃{red}⣼⣤⣰{magenta}⠃⡼⢸⣼⣿⣿⣿⣿⣿⠛⠉⠀⠀⠀⠀⠀⠀⢀⡿⣿⠀
                                ⠀⠀⠀⠀⠀⠀⡞⠛⢳⠌⠁{red}⢰⣿⣿⣿⡗⠓⢺⣿⣿⣿⡷{magenta}⠃⢠⠗⠋⣿⣿⣿⠪{red}⠥⣄⡀{magenta}⠀⠀⠀{red}⢀⣀{magenta}⣨⠡⣿⠂
                                ⠀⠀⠀⠀⠀⠀⠙⠲⠤⣤⡀⠀{red}⠉⠉⠉{magenta}⠀⠀⠀{red}⠉⠛⠉{magenta}⠀⢹⡌⠑⣾⡏⠲⣌⠀⠀⠀{red}⠉⠋{magenta}⠀⠀{red}⠉{magenta}⠀⢠⠈⣿⠁
                                ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⠲⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⡴⠞⠀⠀⠈⠙⠒⠚⣄⠀⠀⠀⠀⠀⠀⠀⠀⢈⡇⠙⠀
                                ⠀⠀⠀⠀⠀⠀⠀⠀⠀⣶⣿⣶⣶⣤⣤⣛⠓⠛⠋⠉⠁⠀⠀⠀⠀⠀⠀⢀⡀⣯⠀⠀⠀⠀⠀⠀⣠⠔⠋⠀⠀⠀
                                ⠀⠀⠀⠀⠀⠀⠀⠀⣼⣿⣿⣿⣿⣿⣿⣿⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢰⣿⣿⣷⣦⣤⡤⠖⠉⠀⠀⠀⠀⠀⠀
                                ⠀⠀⠀⠀⠀⠀⠀⣼⣿⣿⣿⣿⣿⣿⣿⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣴⣿⣿⣿⣿⣿⣿⣿⣷⠄⠀⠀⠀⠀⠀⠀
...
async def help(ctx, page: int = 1):
    ...
    if 1 <= page <= total_pages:
        await ctx.send(f"```                                    Welcome to [ COZY SELFBOT ] ```")
